...
<html><head><!-- Website template by freewebsitetemplates.com -->
	...
	<title>Wood Working Website Template</title><link rel="stylesheet" href="css/style.css" type="text/css"></head>
			...
			<div class="body">
				<div id="adbox">
					...
					<div class="details">
						...
						<p>
You can choose from our wide selection of furnitures on display. Either
for your home, office or other estab- lishments. If you can’t find what
you need, we can make it according to your needs. </p>
					</div>
				</div>
				<ul id="featured">
					<li>
			...
			<div id="links">
				...
				<div>
					<form action="#" method="post" id="newsletter">
						...
						<input value="Enter Email Address Here For Updates" onblur="javascript:if(this.value==''){this.value=this.defaultValue;}" onfocus="javascript:if(this.value==this.defaultValue){this.value='';}" type="text">
						<input value="Sign up" class="btn2" type="submit">
					</form>
					<div id="connect">
						<h4>Social Media</h4>
